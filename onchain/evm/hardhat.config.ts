			...
			addNetworksFromKnownList(
				...
				addNetworksFromEnv({
					...
					default: {
						...
						//},
						accounts: {
							mnemonic: //'witness unfold add aunt shell monster census flush plastic tube twist machine',
								process.env.MNEMONIC || 'test test test test test test test test test test test junk', //process.env.MNEMONIC ||
						},
					},
					//sepolia: {
					//	type: "edr-simulated",
